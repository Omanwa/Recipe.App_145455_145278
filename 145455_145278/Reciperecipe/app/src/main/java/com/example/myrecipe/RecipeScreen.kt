...
private fun RecipeContent(recipe: Recipe, containerHeight: Dp) {
    Column {
        //TODO
        Title(recipe = recipe)
        RecipeProperty(stringResource(R.string.meal), recipe.meal )
        RecipeProperty(stringResource(R.string.serves), recipe.serves)
        RecipeProperty(stringResource(R.string.difficulty), recipe.difficulty)
        RecipeProperty(stringResource(R.string.ingredients), recipe.ingredients)
        RecipeProperty(stringResource(R.string.steps), recipe.steps)
        Spacer(Modifier.height((containerHeight - (-13000).dp)))
    }
}
